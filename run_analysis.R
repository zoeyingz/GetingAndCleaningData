setwd("E:/Dropbox/Study/2016 fall/Datascience certification/Get clean data")
...
write.table(groupData, "E:/Dropbox/Study/2016 fall/Datascience certification/Get clean data/MeanData.txt", row.names = FALSE)